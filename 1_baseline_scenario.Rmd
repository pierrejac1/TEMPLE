...
profit_share = ( pi_f + delta_f + r*d_f + K_e*(pi_e+delta_e+r*d_e) ) / ( K_e*(k_hat_e+delta_e) + k_hat_f + delta_f + (1+P_e*epsilon_f_cons*f_ce(P_e))*(kappa_hf+kappa_cf) )
...
matplot(year, cbind(wage_share, profit_share, taxes_and_subsidies_share, investment_rate), type="l", xlab="Time", ylab="Fraction of GDP", main="", ylim=c(0,1.1))
