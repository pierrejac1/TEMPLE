---
title: "TEMPLE model: simulation for the first scenario (baseline, no energy transition)"
...
intermediateVar <- c(epsilon_e = "(1-chi)*epsilon_nre + chi*epsilon_re",
                     ...
                     pi_e = "P_e*u_e/gamma_e * (1-uc_e-T_e0) - r*d_e",
                     ...
                     p_hat_f = "beta_pf1 * (mu_f*uc_f - 1) + beta_pf2 * (eta*u_f/gamma_f - nu_f)",
...
matplot(year, mismatch * gamma_f/u_f * 100, type="l", xlab="Time", ylab="Percentage of final goods production", main="Mismatch between offer and demand")
grid(col = "grey54", lty = "dotted", lwd = par("lwd"), equilogs = TRUE)
...
matplot(year, cbind(u_f,u_e,u_f_e,u_e_target), type="l", xlab="Time", ylab="", main="Utilization rates")
