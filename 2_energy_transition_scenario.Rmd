---
title: "TEMPLE model: simulation of the energy transition scenario"
...
intermediateVar <- c(EROI_nre = "1 + A*exp(-B*cum_y_nre)",
                     ...
                     uc_e_target_first = "min(omega_e*gamma_e_target_first/u_e_target_first + epsilon_e + gamma_e_target_first*delta_e/(P_e*u_e_target_first), 0.5391434)",
...
matplot(year, cbind(mismatch*gamma_f/u_f*100, forced_savings_workers*gamma_f/u_f*100, forced_savings_capitalists*gamma_f/u_f*100), type="l", xlab="Time", ylab="Percentage of final goods production", main="Mismatch between offer and demand")
