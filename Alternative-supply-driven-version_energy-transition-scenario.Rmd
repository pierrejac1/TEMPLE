---
title: "TEMPLE model: simulation of the energy transition scenario with the alternative, supply-driven version of the model"
...
intermediateVar <- c(EROI_nre = "1 + A*exp(-B*cum_y_nre)",
                     ...
                     uc_e_target_first = "min(omega_e*gamma_e_target_first/u_e_target_first + epsilon_e + gamma_e_target_first*delta_e/(P_e*u_e_target_first), 0.5496152)",
                     ...
                     forced_savings_capitalists = "mismatch/4",
                     forced_savings_workers = "mismatch * 3/4",
                     ...
                     S_e = "max((uc_e-0.5496152)*mu_e, 0)", # Subsidies to the energy firms
...
matplot(year, cbind(mismatch*gamma_f*100, forced_savings_workers*gamma_f*100, forced_savings_capitalists*gamma_f*100), type="l", xlab="Time", ylab="Percentage of final goods production", main="Mismatch between supply and demand")
...
legend("topleft", legend = c("wage share","profit share", "investment rate"), fill= c(1,2,3))
grid(col = "grey54", lty = "dotted", lwd = par("lwd"), equilogs = TRUE)
...
matplot(year, pi_bu, type="l", xlab="Time", ylab="", ylim=c(0,0.006))
legend("topleft", legend = c("pi_bu"), fill= c(1))
grid(col = "grey54", lty = "dotted", lwd = par("lwd"), equilogs = TRUE)

matplot(year, of_b, type="l", xlab="Time", ylab="", ylim=c(0,0.05))
